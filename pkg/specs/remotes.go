...
type Remote struct {
	...
	// The defined prompt are regex (true) or not (false
	CiscoPromptRegex bool   `json:"cisco_prompt_regex,omitempty" yaml:"cisco_prompt_regex,omitempty"`
...
func (r *Remote) GetCiscoPromptRegex() bool { return r.CiscoPromptRegex }
